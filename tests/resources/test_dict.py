# -*- coding:utf-8 -*-
"""
:filename: tests.resources.test_dict.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Tests of pronunciation dictionary, mapping and unigram.
...
from sppas.src.resources.wordstrain import sppasWordStrain

# ---------------------------------------------------------------------------

DICT_TEST = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                         "data", "dict.txt")
DICT_TEST_OK = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                            "data", "dict_ok.txt")
DICT_TEST_XML = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                             "data", "dict_xml.txt")
STRAIN_TEST = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                           "data", "vocab.lem")
