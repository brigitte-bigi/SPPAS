# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_transcription.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Test sppasTranscription() class.
...
from sppas.src.anndata.anndataexc import HierarchyAssociationError
