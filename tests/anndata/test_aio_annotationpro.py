# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_aio_annotationpro.py
...
from sppas.src.anndata.aio.annotationpro import sppasANTX
from sppas.src.anndata.aio.annotationpro import sppasANT
...
class TestANTX(unittest.TestCase):
    ...
    def test_members(self):
        ...
        self.assertTrue(txt.empty_tier_support())
