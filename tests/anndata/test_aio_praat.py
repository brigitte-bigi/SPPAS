# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_aio_praat.py
...
from sppas.src.anndata.anndataexc import AioLineFormatError
from sppas.src.anndata.anndataexc import AioEmptyTierError
from sppas.src.anndata.anndataexc import AioNoTiersError

from sppas.src.anndata.aio.praat import sppasBasePraat
from sppas.src.anndata.aio.praat import sppasTextGrid
from sppas.src.anndata.aio.praat import sppasBaseNumericalTier
...
class TestTextGrid(unittest.TestCase):
    ...
    def test_chronological(self):
        fn = os.path.join(DATA, "F_F_B003_P8_chronological.TextGrid")
        self.assertTrue(sppasTextGrid.detect(fn))
        with self.assertRaises(NotImplementedError):
            sppasTextGrid().read(fn)
