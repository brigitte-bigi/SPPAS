...
from sppas.src.anndata.aio.table import sppasTable, sppasARFF, sppasXRFF
...
class TestTableExport(unittest.TestCase):
    ...
    def test_fix_all_possible_instance_steps(self):
        ...
        weka = sppasTable()
        all_points = weka._fix_all_possible_instance_steps(0., 10., time_step=0.01)  # phoneme frames
        self.assertEqual(len(all_points), 1000)
        all_points = weka._fix_all_possible_instance_steps(0., 10., time_step=0.04)  # video frames
        self.assertEqual(len(all_points), 250)

        all_points = weka._fix_all_possible_instance_steps(0., 10., anchor_tier=tier)
    ...
    def test_fix_instance_steps(self):
        ...
        all_points = weka._fix_all_possible_instance_steps(1., 6., time_step=0.1)
