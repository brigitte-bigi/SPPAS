# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_aio_sclite.py
...
from sppas.src.anndata.aio.sclite import sppasBaseSclite
from sppas.src.anndata.aio.sclite import sppasCTM
from sppas.src.anndata.aio.sclite import sppasSTM
