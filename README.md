...
It is generated by [ClammingPy](https://brigitte-bigi.github.io/ClammingPy/) and uses
[Whakerexa](https://brigitte-bigi.github.io/Whakerexa/) for accessibility (light/dark mode, dyslexia-friendly font, WCAG spacing).
To re-generate it:

```
$ pip install pygments markdown2 "ClammingPy>=3.1"
$ python makedoc.py
```
