# -*- coding:utf-8 -*-
"""
:filename: sppas.src.calculus.tests.test_infotheory.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Tests for infotheory calculus
...
from sppas.src.calculus.infotheory.perplexity import sppasPerplexity
