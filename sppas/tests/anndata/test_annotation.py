# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_annotation.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Test sppasAnnotation() object.
...
class TestAnnotation(unittest.TestCase):
    ...
    def test_hash(self):
        # Copy the annotation, including the id
        copied = self.annotationI.copy()
        # Test when annotation is in dict.
        d = dict()
        d[self.annotationI] = 0
        self.assertTrue(self.annotationI in d)
        self.assertFalse(self.annotationI is copied)
        self.assertTrue(copied in d)   #  &@#ù%^grrr! side effect of __hash__
