# -*- coding: UTF-8 -*-
"""
:filename: sppas.tests.anndata.test_aio_transcriber.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Test the reader of SPPAS for Transcriber files.
...
from sppas.src.anndata.aio.transcriber import sppasTRS
