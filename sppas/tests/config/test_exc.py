...
# -*- coding : UTF-8 -*-
"""
:filename: sppas.tests.config.test_exc.py
...
from sppas.core.coreutils import *
...
class TestExceptions(unittest.TestCase):
    ...
    def test_value_errors(self):
        ...
        try:
            ...
            self.assertTrue(isinstance(e, LanguageNotFoundError))
            self.assertIn("0350", str(e))
            self.assertEqual(e.status, 350)
