#!/usr/bin/env python
"""
:filename: scripts.acmtrain.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: a script to train an acoustic model.
...
from sppas.src.annotations.Align import sppasHTKModelTrainer
from sppas.src.annotations.Align import sppasTrainingCorpus
from sppas.src.annotations.Align import sppasDataTrainer
