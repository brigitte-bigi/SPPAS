...
date:       2024-03-19
version:    2.4
copyright:  Copyright (C) 2017-2024 Brigitte Bigi
...
This plugin allows creating annotations of the classification of phonemes:
class, place of articulation, manner of articulation, phonation, etc.
...
A file with time-aligned phonemes is required: it's a file including a tier
with name "PhonAlign" based on the SPPAS-SAMPA phonemes encoding.

This plugin is using a classification file (phonemes.csv) in order to convert
the phonemes into each class, which is a column in the file.
This file is available in the plugin directory and can be easily modified.
