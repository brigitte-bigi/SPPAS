...
# -*- coding: utf8 -*-
"""
:filename: sppas.src.models.slm.test.test_slm.py
:author:   Brigitte Bigi
:contact:  contact@sppas.org
:summary:  Tests for Statistical language model.
...
from sppas.src.annotations.Align.models.slm.ngramsmodel import sppasNgramCounter
from sppas.src.annotations.Align.models.slm.ngramsmodel import sppasNgramsModel
from sppas.src.annotations.Align.models.slm.statlangmodel import sppasSLM
