# -*- coding:utf-8 -*-
"""
:filename: sppas.src.annotations.Align.models.test.test_acm.py
:author:   Brigitte Bigi
:contact:  contact@sppas.org
:summary: Tests of acoustic models.
...
class TestTrainer(unittest.TestCase):
    ...
    def test_phoneset(self):
        ...
        pho.add_from_dict(os.path.join(paths.resources, "dict", "fra.dict"))
        self.assertEqual(38, len(pho))  # sp is missing
    ...
    def test_trainingcorpus(self):
        ...
        self.assertTrue(corpus.add_file(os.path.join(DATA, "F_F_B003-P8-palign.TextGrid"),
                                        os.path.join(DATA, "F_F_B003_P8.wav")))
    ...
    #     corpus.lang = "fra"
    #     corpus.datatrainer.protodir = os.path.join(DATA, "protos")
    #     corpus.add_file(os.path.join(DATA, "F_F_B003-P8-palign.TextGrid"), os.path.join(DATA, "F_F_B003_P8.wav"))
