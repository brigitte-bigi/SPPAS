...
class sppasStopWords(sppasBaseAnnotation):
    ...
    def set_alpha(self, alpha):
        ...
        Use 0 to not add any stopwords and use only the original list.

        :param alpha: (float) A value in range (0., 4.)
        ...
        for ann in tier:
            ...
            for label in ann.get_labels():
                ...
                if content not in symbols.all:
                    ...
                    _label = sppasLabel(sppasTag(stp, tag_type="bool"))
                    _label.set_key(content)
