# -*- coding: UTF-8 -*-
"""
:filename: sppas.src.anndata.transcription.py
:author:   Brigitte Bigi
:contact:  contact@sppas.org
:summary:  The main object to represent transcriptions of recordings.
    ...
    def contains(self, tier):
        ...
        for t in self._tiers:
            ...
            if t.get_id() == tier.get_id():
                # A different object but with an identical identifier
                return True
        return False
