...
class sppasXRA(sppasBaseIO):
    ...
    def __init__(self, name=None):
        ...
        # 1.4 -> 1.5: support of sppasTag() of type "point" and "rect"
        self.__format = "1.5"
    ...
    def _parse_tag(tag_node):
        ...
        # Attribute type (str, bool, int, float, point)  # point added in XRA 1.5
        if 'type' in tag_node.attrib:
            data_type = tag_node.attrib['type']
        else:
            data_type = "str"

        # Create the sppasTag(). Information is given "as it",
        # i.e. it's a string representing its content and its data type
    ...
    def format_label(label_root, label):
        ...
        """
        # new in XRA 1.5. A label has an optional key attribute.
