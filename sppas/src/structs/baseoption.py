...
# distutils package is removed in python version 3.12 (PEP 632)
# from distutils.util import strtobool
from sppas.core.coreutils import u
from sppas.core.coreutils import text_type
from sppas.core.coreutils import binary_type
...
def strtobool(val):
    ...
    :return: (int) 1 for True, 0 for False, -1 for unknown.
