...
from sppas.src.structs.structsexc import MetaKeyError
from sppas.src.structs.structsexc import LangTypeError
from sppas.src.structs.structsexc import LangNameError
from sppas.src.structs.structsexc import LangPathError
