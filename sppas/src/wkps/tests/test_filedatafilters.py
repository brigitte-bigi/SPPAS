...
from sppas.src.wkps.filedatacompare import *
from sppas.src.wkps.filedatafilters import sppasFileDataFilters
...
class TestsFileDataFilter (unittest.TestCase):
    ...
    def test_extended(self):
        ...
        files.add_file(os.path.join(paths.samples, 'samples-fra', 'F_F_B003_P8.wav'))
        ...
        fr1 = files.get_object(FileRoot.root(os.path.join(paths.samples, 'samples-fra', 'F_F_B003_P8.wav')))
        fr1.add_ref(rf)
        fr1.add_ref(spk1)

        fr2 = files.get_object(FileRoot.root(os.path.join(paths.samples, 'samples-fra', 'F_F_B003_P9.wav')))
        fr2.add_ref(rf)
        fr2.add_ref(spk1)
