# -*- coding: UTF-8 -*-
"""
:filename: sppas.src.imgdata.imgsimilarity.py
...
class sppasImagesSimilarity(object):
    ...
    def train_recognizer(self):
        ...
        try:
            ...
            raise Exception("Error with OpenCV. You probably need to uninstall opencv-python, "
                            "and/or to re-install opencv-contrib-python: {:s}".format(str(e)))
