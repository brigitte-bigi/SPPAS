...
class TranslatorManager:
    ...
    def get_language(self) -> str:
        ...
        It returns the first language of the active language list.
        If empty, fallback to the default language.

        """
        return self._lang[0] if len(self._lang) > 0 else self.get_default_lang()
