...
class DepsFeatureChecker:
    ...
    def check(self, do_report=False) -> list:
        """Check if the defined dependencies can be imported or executed.

        :param do_report: whether to report errors or not in a file and in web browser
    ...
    @staticmethod
    def check_commands(test_commands) -> None:
