...
from .dashboardmaker import DashboardAppResponseRecipe
...
class DashboardWebData(swappWebData):
    ...
    def __init__(self, json_filename: str | None = None) -> None:
        ...
        self._default = DashboardAppResponseRecipe.page()
    ...
    def is_page(self, page_name: str) -> bool:
        ...
        """
        return page_name == DashboardAppResponseRecipe.page()
    ...
    def bake_response(self, page_name: str, default: str = "") -> BaseResponseRecipe | None:
        ...
        if page_name == DashboardAppResponseRecipe.page():
            return DashboardAppResponseRecipe()
