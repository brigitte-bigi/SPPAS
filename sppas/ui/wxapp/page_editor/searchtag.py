# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.page_editor.searchtag.py
...
from sppas.ui.wxapp.events import sb
from sppas.ui.wxapp.windows import sppasDialog
from sppas.ui.wxapp.windows.book import sppasNotebook
from sppas.ui.wxapp.windows import sppasPanel
from sppas.ui.wxapp.windows import sppasStaticLine
from sppas.ui.wxapp.windows import BitmapTextButton
from sppas.ui.wxapp.windows import sppasCheckBoxPanel
from sppas.ui.wxapp.panel_shared import sppasTagStringPanel
from sppas.ui.wxapp.panel_shared import sppasTagIntegerPanel
from sppas.ui.wxapp.panel_shared import sppasTagFloatPanel
from sppas.ui.wxapp.panel_shared import sppasTagBooleanPanel
...
MSG_HEADER_SEARCH = info(9200, "ui")
MSG_ACTION_CLOSE = msg("Close", "ui")
MSG_ACTION_HIDE = msg("Hide", "ui")
MSG_ACTION_FORWARD = msg("Next", "ui")
MSG_ACTION_BACKWARD = msg("Previous", "ui")

TOOLTIP_ACTION_CLOSE = info(9201, "ui")
TOOLTIP_ACTION_HIDE = info(9211, "ui")
TOOLTIP_ACTION_FORWARD = info(9221, "ui")
TOOLTIP_ACTION_BACKWARD = info(9231, "ui")
...
class sppasSearchTagDialog(sppasDialog):
    ...
    def notify(self, action, filename=None, value=None):
...
class SearchActionsPanel(sppasPanel):
    ...
    def __init__(self, parent):
        ...
        close_btn.SetToolTip(TOOLTIP_ACTION_CLOSE)
        hide_btn = self._create_button(MSG_ACTION_HIDE, "hide")
        hide_btn.SetToolTip(TOOLTIP_ACTION_HIDE)
        forward_btn = self._create_button(MSG_ACTION_FORWARD, "search_forward")
        forward_btn.SetToolTip(TOOLTIP_ACTION_FORWARD)
        backward_btn = self._create_button(MSG_ACTION_BACKWARD, "search_backward")
        backward_btn.SetToolTip(TOOLTIP_ACTION_BACKWARD)
        ...
        sizer.Add(hide_btn, 1, wx.ALL | wx.EXPAND, 0)
...
class TestPanel(wx.Panel):
    TEST_FILES = (
        ...
        os.path.join(paths.samples, "samples-eng", "ENG_M15_ENG_T02.PitchTier"),
    )
