# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.page_home.links.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Panel to show a link with a nice look.
...
class LinkButton(BaseButton):
    ...
    def __draw_bitmap(self, dc, gc, x, y, btn_size):
        ...
        try:
            ...
            img = sppasImagesAccess.get_image(self._image)
            # re-scale the image to the expected size
            sppasImagesAccess.rescale_image(img, btn_size)
            # convert to bitmap
...
class sppasLinksPanel(sppasPanel):
    ...
    def _create_content(self):
        ...
        b1 = LinkButton(self, name="sppas_logo_v3_64x64")
        b1.SetLinkLabel("SPPAS Home")
        b1.SetLinkURL("https://sppas.org/")
        ...
        b2.SetLinkURL("https://sppas.org/documentation.html")
        ...
        b3.SetLinkURL("https://sppas.org/tutorial.html")
        ...
        b4.SetLinkURL("https://sppas.org/faq.html")
        ...
        b5.SetLinkURL("https://sppas.org/bigi/")
    ...
    @property
    def home_btn(self):
        return self.FindWindow("sppas_logo_v3_64x64")
