# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.windows.toolbar.py
...
class sppasToolbar(sppasPanel):
    ...
    def AddWidget(self, wxwindow):
        ...
        if self.GetSizer().GetOrientation() == wx.HORIZONTAL:
            self.GetSizer().Add(wxwindow, 2, wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        else:
            self.GetSizer().Add(wxwindow, 2, wx.TOP | wx.BOTTOM | wx.EXPAND, 2)
        self.Show(True)
    ...
    def AddTextButton(self, name="sppasButton", text=""):
        ...
        btn.SetName(name)
        if self.GetSizer().GetOrientation() == wx.HORIZONTAL:
            self.GetSizer().Add(btn, 2, wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        else:
            self.GetSizer().Add(btn, 2, wx.TOP | wx.BOTTOM | wx.EXPAND, 2)
        return btn
    ...
    def AddButton(self, icon, text=None, tooltip=None):
        ...
        """
        btn = self.create_button(text, icon, tooltip)
        if self.GetSizer().GetOrientation() == wx.HORIZONTAL:
            self.GetSizer().Add(btn, 2, wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        else:
            self.GetSizer().Add(btn, 2, wx.TOP | wx.BOTTOM | wx.EXPAND, 2)
    ...
    def AddText(self, text="", color=None,
        ...
        if color is not None:
            ...
            self.__fg.append(st)
        self.GetSizer().Add(st, 1, align | wx.ALL, 2)
    ...
    def create_button(self, text, icon, tooltip=None):
