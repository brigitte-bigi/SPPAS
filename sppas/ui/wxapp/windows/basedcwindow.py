# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.windows.basedcwindow.py
...
from sppas.core.config import paths        # used in the TestPanel only
...
class sppasDCWindow(wx.Window):
    ...
    @staticmethod
    def GetHighlightedColour(color, delta=20):
    ...
    def SetSize(self, size):
        ...
        if h < self._min_height:
            h = self._min_height
        wx.Window.SetSize(self, wx.Size(w, h))
