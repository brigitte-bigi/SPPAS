# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.windows.buttons.bitmapbutton.py
...
class BitmapTextButton(TextButton):
    ...
    def _draw_bitmap(self, dc, gc, x, y, btn_size):
        ...
        try:
            ...
            img = sppasImagesAccess.get_image(self._icon_image)
...
class TestPanelBitmapTextButton(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        b3 = BitmapTextButton(self, label="sppas_logo_v3_64x64",
                              pos=(300, 100), size=(50, 50),
                              name="sppas_logo_v3_64x64")
        b3.SetBorderWidth(1)
        b3.SetLabel("RENAMED")
        b3.Refresh()
