# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.windows.basewindow.py
...
from sppas.core.config import paths   # paths is used in the TestPanel only

from ..events import sb   # for tests
from ..events import sppasWindowFocusedEvent
from ..events import sppasWindowSelectedEvent
