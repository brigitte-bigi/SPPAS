# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.page_analyze.statsview.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: View of statistical distributions of the annotations of tiers.
...
from sppas.ui.wxapp.windows import Confirm
from sppas.ui.wxapp.windows import sppasFileDialog
from sppas.ui.wxapp.windows import sppasDialog
from sppas.ui.wxapp.windows import sppasPanel
from sppas.ui.wxapp.windows import sppasRadioBoxPanel
from sppas.ui.wxapp.windows.book import sppasNotebook
from sppas.ui.wxapp.windows.listctrl import SortListCtrl

# --------------------------------------------------------------------------


MSG_HEADER_STATSVIEW = _("View descriptive stats of tiers")
OPT_TAG_BEST = _("Use only the tag with the best score")
OPT_TAG_ALT = _("Use alternative tags")
OPT_TAGS = _("Annotation label tags: ")
OPT_MIDPOINT_ONLY = _("Use only midpoint value")
OPT_MIDPOINT_RADD = _("Add the radius value")
OPT_MIDPOINT_RDEL = _("Deduct the radius value")
OPT_DUR = _("Annotation durations: ")
MSG_CONFIRM_OVERRIDE = \
    _("A file with name {:s} is already existing. Override it?")
MSG_CONFIRM_NAME = _("Confirm file name?")
MSG_ACT_SAVE = _("Save")
MSS_SELECTED = _("Selected statistical distribution: {:s}")
