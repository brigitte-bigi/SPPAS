# -*- coding: UTF-8 -*-
"""
:filename: src.ui.wxapp.page_analyze.filters.single.py
...
from sppas.ui.wxapp.windows import CheckButton
from sppas.ui.wxapp.windows import sppasTextCtrl, sppasStaticText
