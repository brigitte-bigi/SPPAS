# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.page_analyze.audioroamer.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: The audio roamer of SPPAS to know more about audio files.
...
from sppas.ui.wxapp.windows import Error
from sppas.ui.wxapp.windows import sppasFileDialog
from sppas.ui.wxapp.windows import sppasDialog
from sppas.ui.wxapp.windows import sppasStaticText, sppasTextCtrl
...
class ChannelInfosPanel(sppasPanel):
    ...
    def __init__(self, parent, channel):
        ...
        self._ca = None           # AudioFrames of this channel, fixed by ShowInfos
    ...
    def SaveAs(self, period=False):
        ...
        try:
            ...
            audioopy.aio.save(pathname, audio)
    ...
    def ShowInfo(self):
        ...
        vmin_db = AudioConverter().amp2db(vmin)
        vmax_db = AudioConverter().amp2db(vmax)
        vavg_db = AudioConverter().amp2db(vavg)
    ...
    def SetChannel(self, new_channel):
        ...
        self._cv = ChannelSilences(self._channel)
