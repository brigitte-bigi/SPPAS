...
:summary: Entry point to launch the wxPython Graphical User Interface of SPPAS
...
To launch the GUI, this main file allows the followings solution:

>>> python3 sppas/ui/wxapp/__main__.py

Here, 'python3' is a link to the python virtuel environment. It was created
during the setup, i.e. either sppas-venv/bin/python (Unix OS) or
sppas-venv/Scripts/python.exe (Windows).
...
sppas_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
