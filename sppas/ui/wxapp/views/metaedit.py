# -*- coding: UTF-8 -*-
"""
:filename: sppas.ui.wxapp.views.metaedit.py
...
from sppas.ui.wxapp.windows.toolbar import sppasToolbar
from sppas.ui.wxapp.windows.listctrl import sppasListCtrl
from sppas.ui.wxapp.windows.line import sppasStaticLine
from sppas.ui.wxapp.windows.text import sppasTextCtrl, sppasStaticText
from sppas.ui.wxapp.windows.book import sppasSimplebook
from sppas.ui.wxapp.windows.buttons import BitmapButton

from sppas.ui.wxapp.windows.dialogs import Error
from sppas.ui.wxapp.windows.dialogs.dialog import sppasDialog

# ---------------------------------------------------------------------------

MSG_HEADER_META = _("Metadata")
MSG_SETS = _("Trusted sets:")
