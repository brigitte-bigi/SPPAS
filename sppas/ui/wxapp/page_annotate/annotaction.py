"""
:filename: sppas.ui.wxapp.page_annotate.annotaction.py
...
from sppas.core.config import annots, paths
    ...
    def _process_event(self, event):
        ...
        for ann_type in annots.types:
            if event_name == "btn_annot_" + ann_type:
                # logging.debug("CALL NOTIFY with destination = page_annot_{:s}".format(ann_type))
