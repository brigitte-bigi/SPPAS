...
if __name__ == "__main__":
    ...
    group_io1 = parser.add_argument_group('Files (manual)')

    group_io1.add_argument(
        "-i",
        metavar="file",
        help='Input filename (extension: .hz or .PitchTier)')
    ...
    group_io2 = parser.add_argument_group('Files (auto)')

    group_io2.add_argument(
        "-I",
        metavar="file",
        action='append',
