...
# -*- coding: UTF-8 -*-
"""
:filename: sppas.bin.vowelfilter.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Run the filtering of the erroneous formant values of a corpus.
...
from sppas.core import sppasPythonFeatureError
from sppas.src.annotations import sppasVowelFilter
...
def get_args_from_cmd(parameters, ann_step_idx):
    ...
    This annotation is filtering a set of files, not a file: no argument is
    proposed to process a single file.
...
def vowelfilter():
    ...
    ann_step_idx = parameters.activate_annotation("vowelfilter")
    ...
    if args.W or args.I:
        ...
        if not args.quiet:
            logging.info("No file was given to be filtered. Nothing to do!")
