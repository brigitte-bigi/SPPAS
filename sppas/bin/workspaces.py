...
from sppas.src.wkps import sppasCatReference
...
if __name__ == "__main__":
    ...
    group_state.add_argument(
        "--check_all",
        action="store_true",
        help="check all the files of the workspace"
    )

    group_state.add_argument(
        "--uncheck_all",
        action="store_true",
        help="uncheck all the files of the workspace"
    )
    group_state.add_argument(
        "-cf",
        metavar="check_file",
        help="check a file (or a reference) of the workspace."
    )

    group_state.add_argument(
        "-uf",
        metavar="uncheck_file",
        help="uncheck a file (or a reference) of the workspace."
    )
