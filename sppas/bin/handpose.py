...
# -*- coding: UTF-8 -*-
"""
:filename: sppas.bin.handpose.py
:author:   Brigitte Bigi
:contact:  contact@sppas.org
:summary:  Run the automatic detections of hand&pose.
...
from sppas.src.annotations import sppasHandPose
...
if __name__ == "__main__":
    ...
    group_io = parser.add_argument_group('Files (manuel):')
    ...
    if args.i:
        ...
        if args.e in sppasFiles.get_outformat_extensions("VIDEO"):
